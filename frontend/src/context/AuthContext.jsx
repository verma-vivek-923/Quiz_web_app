...
export const AuthProvider = (props) => { // Change name to `AuthProvider`
    ...
    return (
        <Auth.Provider value={{ start, exit, setStart, setExit,ansCorrect,setAnsCorrect, quizzes,correct,setCorrect}}>
            {props.children}
        </Auth.Provider>
    );
};
