...
const QuizHistory = () => {
  ...
  return (
    <div className="w-full h-screen flex relative flex-col items-center">
      ...
      <div className="flex flex-col mt-12 items-center min-h-screen p-2 md:p-6">
        <h1 className="text-3xl flex items-center gap-4 font-bold mb-6"><FaHistory /> Quiz History</h1>
